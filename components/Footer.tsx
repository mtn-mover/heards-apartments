      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">HEART Apartments Interlaken</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/apartments" className="text-gray-400 hover:text-white transition-colors text-sm">
                  {nav('apartments')}
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} HEART Apartments Interlaken. {t('copyright')}
            </p>
            <p className="text-gray-500 text-sm flex items-center">
              {t('madeWith')} <span className="text-red-500 mx-1">❤️</span> in Interlaken
            </p>
          </div>
        </div>
      </div>
